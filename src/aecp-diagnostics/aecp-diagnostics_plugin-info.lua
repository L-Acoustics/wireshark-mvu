...
m._info = {
	version = "0.0.1.0",
	author = "L-Acoustics",
	description = "Lua plugin for additional diagnostics information in IEEE1722.1 AECP frames in Wireshark",
	repository = "https://github.com/L-Acoustics/wireshark-aecp-diagnostics"
}
